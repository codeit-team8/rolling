...
/**
 * 롤링 페이퍼 대상 목록 조회 API
 * @param limit: Integer 리턴받기 원하는 질문 대상 객체 수. 기본값은 8
 * @param offset: Integer 가장 앞 객체부터 건너 뛰고 싶은 객체 수.
 * @param sort: String "Like" 를 넣으면 총 리액션 순서대로 목록 정렬
 * @returns {Promise<any>}
 */
...
/**
 * 롤링 페이퍼 대상 생성 API
 * @param name : 롤링 페이퍼 대상의 이름
 * @param backgroundColor : 롤링 페이퍼 배경색. 기본값은 베이지
 * @param backgroundImageURL: 롤링 페이퍼 배경 URL.(Optional)
 * @returns {Promise<any>}
 */
